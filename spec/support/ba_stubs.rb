RSpec.configure do |config|
  config.before :each do
    stub_request( :get,
                  'https://joe%40example.com:joesthebest@rooland.billapp.cz/invoices.json'
    )
    ...
    stub_request(:get, 'https://joe%40example.com:joesthebest@rooland.billapp.cz/invoices/96765.json')
      .with(:headers => { 'Accept'=>'application/json',
                          'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
                          'User-Agent'=>'Ruby'
            })
